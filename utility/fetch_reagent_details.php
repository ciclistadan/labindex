...
//use the field_attributes table to get a list of field names for this reagent type
    $sql_fields = "SELECT field_attr_column_name FROM field_attributes WHERE field_attr_tags = '" . mysql_real_escape_string(trim($_GET['r_reagent_type'])) . "' OR field_attr_tags = 'all'";
...
//retrive details 
        $sql = "SELECT *  FROM reagents WHERE r_rid = " . mysql_real_escape_string(trim($_GET['r_rid']));
